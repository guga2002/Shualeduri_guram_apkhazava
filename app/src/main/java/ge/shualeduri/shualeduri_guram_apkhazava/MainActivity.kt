package ge.shualeduri.shualeduri_guram_apkhazava
...
class MainActivity : AppCompatActivity() {
    ...
    fun onButtonClicked(view: View) {
        val meore = Intent(this, meoregverdi::class.java).apply {
            putExtra("monacemi", editText.text.toString())//meore activityshi mivwvdebit  shesabamisi saxelit
        }

        startActivity(meore)//winadadebis gadawodeba
        startActivity(Intent(this@MainActivity, meoregverdi::class.java))//meore gverdze gadasvla dazgvevis miznit tu intent ma arimushava
